...
export const Sidebar = ({
  ...
  return (
    <div className="md: sticky bottom-0 z-10 flex justify-around bg-white px-4 py-2 transition dark:bg-black md:top-0 md:h-screen md:flex-col md:justify-start md:py-4 md:pl-0">
      <Navlink href="/">
        <FaKiwiBird size={30} />
      </Navlink>
